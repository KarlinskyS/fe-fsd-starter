...
4. Технологический стек: TS, React, TanStack, React Hook Form, методология FSD, подход public API для папок, Vite.
5. Базовые принципы FSD:
