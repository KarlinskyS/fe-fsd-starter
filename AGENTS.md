...
23. Локализация (i18n):
- Полный запрет на plain strings в UI/приложении: любой текст — только через `t('translationKey')`, без исключений.
- При добавлении любого текста обязателен завод ключей перевода во всех локалях.
